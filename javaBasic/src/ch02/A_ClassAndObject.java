...
class ExampleClass1 { 
	...
	int method1 (int arg1, int arg2) {
		// 기능 구현
		// 반환타입이 void 가 아니면 반드시 return 으로 결과를 반환해야 함
		return 0;
	}
	...
	void method3 (int arg1) {
		// void 에서의 return 은 강제로 메서드를 종료하기 위해 사용
		return;
	}
	// 매개변수 : X, 반환값 : X
	void method4 ( ) {
...
//	}
	...
	ExampleClass1 (int attribute1) {
		// this();    // 생성자
		this(attribute1, -99.99);  // 생성자 내부에서만 부를수 있음
	}
...
public class A_ClassAndObject {
	...
	public static void main(String[] args) {
		...
		// 클래스명 참조변수명 = new 클래스명();
		ExampleClass1 instance1 = new ExampleClass1(0, 0);   // 매개변수를 넣지않음
		...
		System.out.println("------------------------------------------------------------");
		System.out.println(instance2.attribute1);		// instance2 를 출력한 이유는 독립성을 보여주기 위함
		System.out.println("------------------------------------------------------------");
...
//		ExampleClass1.method1(0, 0);
		...
		// instance4.attribute1 = 999;   // 필요 없어진 작업
