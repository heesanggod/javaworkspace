...
// JVM의 메모리 구조
// 메서드 영역: 모든 쓰레드가 공유하며 클래스의 구조 정보와 static으로 선언된 변수 혹은 메서드가 정장되는 공간
...
// 아래와 같은 클래스이 구조 정보는 '메서드 영역'에 저장된다.
class Class {
	// 클래스 변수는 데이터는 '메서드 영역'에 저장된다.
...
public class A_JVM {
	...
	public static void main(String[] args) {
		...
		// 호출한 메서드가 종료되면 스택 영역에서 자동으로 제거가 된다.
