...
// 캡슐화: 멤버 변수(속성)와 메서드를 묶어서 변수에 대한 조작을 메서드를 통해서 만 할 수 있도록 하는 것
...
class FootballPlayerB {
	...
	String getBirth () {
		return this.birth; // 생물의 생일같은 경우는 절대로 바뀌지 않기 때문에 void setBirth 는 안만듬
	}
...
public class E_Encapsulation {
	...
	public static void main(String[] args) {
		...
		FootballPlayerB son = new FootballPlayerB("손흥민", "1158", "토트넘 홋스퍼", 0);
//		son.name = "손흥민";
//		son.team = "토트넘 홋스퍼";
//		son.goal = 0;
