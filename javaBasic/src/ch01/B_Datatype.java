...
public class B_Datatype {
	...
	public static void main(String[] args) {
		...
		long long1 = 2_147_483_648L; // long형의 경우 뒤에 'L' 또는 'l'을 붙여준다
		
		// 실수형 데이터 타입: 실수부를 가지는 데이터 타입
		// float: 4byte(32bit)의 크기를 가지는 실수형 데이터 타입
		// 소수점 6-7 자리에서 오차가 발생
		float float1 = 3.1415926535F;    // float형의 경우 뒤에 'F' 또는 'f'를 붙여준다.
		System.out.println(float1);
		
		// double: 8byte(64bit)의 크기를 가지는 실수형 데이터 타입
		// 소수점 15-17 자리에서 오차가 발생
		double double1 = 3.1415926535;
		System.out.println(double1);    // double형은 숫자 뒤에 아무 것도 붙이지 않습니다. 'D' 또는 'd'를 붙여도 되지만, 일반적으로 생략한다.
...
//		System.out.println(number2);
		...
		// 문자열을 다루는데 유요한 여러가지 기능을 제공해주고 있음
